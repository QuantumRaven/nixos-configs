...
alias path-containers="cd /mnt/hq/dev/containers"
...
alias path-github="cd /mnt/hq/github-projects"
...
alias tmux-n="tmux new-session -s"
alias tmux-a="tmux attach-session -t"
alias tmux-ksess="tmux kill-session -t"
alias tmux-kserv="tmux kill-server"
alias tmux-l="tmux list-sessions"
alias nos-test="sudo nixos-rebuild test"
alias nos-switch="sudo nixos-rebuild switch"
alias nos-sync="sudo rsync -avhP ./*.nix ./users /etc/nixos/"
'';
}
